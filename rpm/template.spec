...
Name:           ros-humble-nicla-vision-ros2
Version:        1.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS nicla_vision_ros2 package

License:        Apache License 2.0
URL:            http://ros.org/wiki/nicla_vision_ros
...
%description
Integration of the Arduino Nicla Vision board in the ROS2 world. Sensors data
from the Nicla Vision is collected and trasmited to the relevant ROS2 topics
...
%changelog
* Mon Jul 22 2024 Davide Torielli <toridebraus@gmail.com> - 1.0.1-1
